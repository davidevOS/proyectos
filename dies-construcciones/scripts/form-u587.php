...
{
	$to = 'israel.espitia@diesconstrucciones.com,pedro.diaz@diezconstrucciones.com,contactenos@diesconstrucciones.com';
	$subject = 'Contáctenos Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre:</b></td><td>' . htmlentities($_REQUEST["custom_U596"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Mensaje:</b></td><td>' . htmlentities($_REQUEST["custom_U590"],ENT_COMPAT,'UTF-8') . '</td></tr>';
